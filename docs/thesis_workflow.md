...
graph TD
    ...
    subgraph Scripts
        comp[compile-thesis.sh]
        prog[generate_progress_report.py]
        word[word_stats.py]
    end
...
## Navigation Links
- Project Map: [[chapter_dependencies|Chapter Dependencies]]
- Key Concepts: [[concept_map|Concept Map]]
- Track Progress: [[progress_tracker|Progress Tracking]]

## Chapter Quick Access
### Foundation
- [[src/chapters/01_introduction|1. Introduction]]
- [[src/chapters/02_fundamentals|2. Fundamentals]]
- [[src/chapters/03_classical_crypto|3. Classical Crypto]]

### Core Analysis
- [[src/chapters/04_classical_vs_quantum|4. Classical vs Quantum]]
- [[src/chapters/05_quantum_impact|5. Quantum Impact]]
- [[src/chapters/06_challenges|6. Challenges]]

### Solutions & Implications
- [[src/chapters/07_quantum_resistant|7. Quantum-Resistant]]
- [[src/chapters/08_future_prospects|8. Future Prospects]]
- [[src/chapters/09_societal_implications|9. Societal Impact]]

## Build Process

### 1. LaTeX Compilation
1. Run `compile-thesis.sh` which:
   - Processes main.tex and included chapter files
   - Generates auxiliary files in build/
   - Creates final PDF output

### 2. Progress Tracking
1. Use `generate_progress_report.py` to:
   - Track chapter completion status
   - Generate progress visualization
   - Update progress_tracker.md

### 3. Statistics Generation
1. Use `word_stats.py` to:
   - Calculate word counts by chapter
...
### Core Files
- `main.tex`: Primary document structure
- `preamble.tex`: Document configuration
- `src/chapters/*.tex`: Chapter content
- `src/bibliography/bibliography.bib`: References
- `src/glossary.tex`: Term definitions

### Supporting Files
- `docs/chapter_dependencies.md`: Chapter relationship map
- `docs/concept_map.md`: Concept relationship map
- `docs/image_reference_guide.md`: Figure usage guide
- `progress_tracker.md`: Progress monitoring
- `docs/thesis_workflow.md`: This workflow guide

## Working with the Project

### Adding Content
1. Create new content in appropriate chapter file
2. Update glossary.tex if new terms are introduced
3. Add references to bibliography.bib
4. Add images to src/images/{chapter}/
...
python3 src/scripts/word_stats.py
```

### Common Tasks
- Update chapter content in src/chapters/
- Add new references to src/bibliography/bibliography.bib
- Add new terms to src/glossary.tex
...
### File Organization
- Place images in chapter-specific folders
- Maintain consistent file naming
- Keep auxiliary files in build/

### Documentation
- Update workflow documentation as needed
- Maintain clear chapter dependencies
- Document image relationships

### Quality Control
- Run complete builds regularly
- Check for LaTeX errors and warnings
- Validate cross-references
- Ensure glossary terms are defined
